...
export default function Lynk() {
  const links = [
    ...
    },
    {
      title: "Tiktok",
      desc: "@fanz_tech",
      url: "https://tiktok.com/@fanz_tech",
      icon: MonitorPlay,
      primary: false,
    },
    {
        ...
        <div className="text-center mb-16 space-y-6">
          <div className="relative inline-block group">
            ...
            <div className="w-24 h-24 sm:w-28 sm:h-28 bg-gray-100 dark:bg-white/5 border-2 border-black dark:border-white flex items-center justify-center overflow-hidden mx-auto">
              <img 
                src="https://ui-avatars.com/api/?name=Fanz+Tech&background=ffffff&color=000000&size=150" 
                alt="Fanz Tech" 
          ...
          <div>
            <h2 className="text-3xl font-bold text-black dark:text-white mb-2">Fanz Tech Studio</h2>
            <p className="text-gray-500 dark:text-gray-400 font-medium max-w-md mx-auto">
              Solusi desain kreatif premium. Hubungi kami melalui tautan resmi di bawah ini.
            </p>
          </div>
        </div>
        ...
        <div className="space-y-0 border-l border-t border-gray-200 dark:border-white/10 bg-white dark:bg-black shadow-[10px_10px_0px_0px_rgba(0,0,0,0.05)] dark:shadow-[10px_10px_0px_0px_rgba(255,255,255,0.05)]">
          {links.map((link, index) => (
            <a
              ...
              className={`group flex items-center gap-5 p-6 sm:p-8 transition-all duration-300 border-b border-r border-gray-200 dark:border-white/10 ${
                link.primary 
            ...
            >
              <div className={`w-12 h-12 flex items-center justify-center flex-shrink-0 transition-transform duration-300 group-hover:scale-110 ${
                link.primary ? "bg-white/10 dark:bg-black/10" : "bg-gray-100 dark:bg-white/5 border border-gray-200 dark:border-white/10"
              }`}>
